...
import LeftCreateVideoConsultationSection from './sections/LeftCreateVideoConsultationSection'
import RightCreateVideoConsultationSection from './sections/RightCreateVideoConsultationSection'

const CreateVideoConsultationPage = () => {
		...
		>
			<Grid container spacing={2}>
				<Grid size={{ xs: 12, md: 6, lg: 7 }} my={2} px={4} py={2}>
					<LeftCreateVideoConsultationSection
				...
				<Grid size={{ xs: 0, md: 6, lg: 5 }}>
					<RightCreateVideoConsultationSection />
				</Grid>
			</Grid>
		</Paper>
	)
...
export default CreateVideoConsultationPage
